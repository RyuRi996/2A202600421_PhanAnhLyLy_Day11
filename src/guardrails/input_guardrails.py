    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response("SECURITY ALERT: Prompt injection detected. Request blocked.")
            
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("POLICY ALERT: Request is off-topic or contains blocked content. Request blocked.")
